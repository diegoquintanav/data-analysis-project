...
setwd("~/Documents/Data_Science/MIRI/2. MVA/HappinessProject")
set.seed(42)
```
...
```{r}
path <- "~/Documents/Data_Science/MIRI/2. MVA/HappinessProject/WHR20_DataForFigure2.1.csv"
...
```
An observation _x_ declared an extreme outlier if it lies outlisde of the interval $(Q1-3\cdot IQR, Q3+3\cdot IQR)$, where $IQR=Q3-Q1$ is called the Interquartile Range. 
